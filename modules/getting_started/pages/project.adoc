...
image:create_project.png[alt="Create Project"]

Fill in some Project metadata:

image:create_project_metadata.png[alt="Create Project"]
...
image:create_project_init.png[alt="Initialize Project"]

After clicking on _Finish_, the schematic and board editors show up and you're
ready to draw the schematics:

image:create_project_editors.png[alt="Project Editor"]

include::schematics.adoc[leveloffset=+1]

include::boards.adoc[leveloffset=+1]

include::production_data.adoc[leveloffset=+1]
