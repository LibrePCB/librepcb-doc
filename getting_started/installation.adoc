...
[WARNING]
====
Please note that LibrePCB is a very young software and thus (probably)
isn't as mature as other EDA tools are. Use LibrePCB at your own risk,
accepting that we don't take responsibility for any implications caused
